...
function About(param)
{
    return (<div style={{background:'white'}} id="About" className="flex">
        ...
        <div style={{position:'relative', left:"-30vw", top:"15vw",display:"inline-block"}}>
            ...
            <h2 style={{fontFamily:"sans-serif",fontWeight:"bold",fontSize:"2vw"}}>Great Digital Agency</h2>
            <p style={{fontFamily:"sans-serif",width:"24vw",fontWeight:"600",fontSize:"1vw"}}>Our products are fully custom-made, built with the latest technologies and cloud-architectures.</p>
            <p style={{fontFamily:"sans-serif",width:"26vw",fontSize:".9vw"}}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam ex odio, turpis accumsan congue. Quisque blandit dui Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. In convallis porta mauris non aliquam.</p>
